...
run_in_docker() {
  ...
  for name in K3S_VERSION K9S_VERSION VLLM_IMAGE CUDA_VALIDATION_IMAGE \
    MODEL_ID MODEL_REVISION HF_TOKEN NVIDIA_DRIVER_BRANCH NVIDIA_KERNEL_FLAVOUR DRIVER_PACKAGES HOST_TOOL_PACKAGES \
...
fingerprint_environment="$({
  for name in K3S_VERSION K9S_VERSION VLLM_IMAGE CUDA_VALIDATION_IMAGE \
    MODEL_ID MODEL_REVISION NVIDIA_DRIVER_BRANCH NVIDIA_KERNEL_FLAVOUR DRIVER_PACKAGES CTK_PACKAGES HOST_TOOL_PACKAGES \
